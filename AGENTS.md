...
- Run cargo clippy --all-targets -- -D warnings on the touched crate before launching tools/check.sh; the full gate costs ten minutes per clippy nit (memento: clippy-before-full-gate)

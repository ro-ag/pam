...
//! Kernel credentials identify an OS owner, NOT GUI mode. Unrestricted same-user
//! processes remain privileged; see docs/admin-boundary.md for the threat model.

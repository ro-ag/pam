        ...
        createPortal(
          ...
          >
            ...
            <fieldset className="mt-4">
              <legend className="mb-2 text-xs font-medium text-ink-muted">Content width</legend>
              <div className="grid grid-cols-2 gap-2">
                <Button
            ...
            <div className="mt-5 border-t border-line pt-4">
              <h3 className="mb-2 text-sm font-medium">
                Saved layouts <span className="text-ink-faint">{workspace.saved.length}/8</span>
              </h3>
